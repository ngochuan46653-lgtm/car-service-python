...
from services.ServiceManagerServeces import ServecesService
...
class ServiceView(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.cb_load = ServecesService.get_all
        self.cb_add = ServecesService.add
        self.cb_edit = ServecesService.update
        self.cb_delete = ServecesService.delete
    ...
    def _show_form(self, title, initial, on_submit):
        ...
        def submit():
            ...
            if not name or not price:
                return self._alert("Vui lòng nhập đầy đủ thông tin!")
            on_submit({"name": name, "price": price})
            dlg.destroy()
    ...
    def _submit_add(self, data):
        try:
            ...
            return self._alert(f"Lỗi thêm dịch vụ: {e}")
        self.refresh()
    ...
    def _submit_edit(self, data):
        try:
            ...
            return self._alert(f"Lỗi cập nhật dịch vụ: {e}")
        self.refresh()
    ...
    def refresh(self):
        try:
            ...
            self._all_rows = []
            self._alert(f"Lỗi tải dịch vụ: {e}")
    ...
    def _safe_delete(self):
        try:
            ...
            self._alert(f"Lỗi xóa dịch vụ: {e}")
